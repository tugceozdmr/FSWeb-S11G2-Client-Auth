...
spurious results.`);
  ...
  function valueFromASTUntyped(valueNode, variables) {
    switch (valueNode.kind) {
      ...
      case Kind.OBJECT:
        return keyValMap(valueNode.fields, (field2) => field2.name.value, (field2) => valueFromASTUntyped(field2.value, variables));
      case Kind.VARIABLE:
  ...
  function validateFields(context, type) {
    ...
    for (const field2 of fields) {
      ...
      if (!isOutputType(field2.type)) {
        var _field$astNode;
        context.reportError(`The type of ${type.name}.${field2.name} must be Output Type but got: ${inspect(field2.type)}.`, (_field$astNode = field2.astNode) === null || _field$astNode === void 0 ? void 0 : _field$astNode.type);
      }
      for (const arg of field2.args) {
        ...
        if (!isInputType(arg.type)) {
          var _arg$astNode2;
          context.reportError(`The type of ${type.name}.${field2.name}(${argName}:) must be Input Type but got: ${inspect(arg.type)}.`, (_arg$astNode2 = arg.astNode) === null || _arg$astNode2 === void 0 ? void 0 : _arg$astNode2.type);
        }
        if (isRequiredArgument(arg) && arg.deprecationReason != null) {
          var _arg$astNode3;
          context.reportError(`Required argument ${type.name}.${field2.name}(${argName}:) cannot be deprecated.`, [
            getDeprecatedDirectiveNode(arg.astNode),
  ...
  function validateInputFields(context, inputObj) {
    ...
    for (const field2 of fields) {
      ...
      if (!isInputType(field2.type)) {
        var _field$astNode2;
        context.reportError(`The type of ${inputObj.name}.${field2.name} must be Input Type but got: ${inspect(field2.type)}.`, (_field$astNode2 = field2.astNode) === null || _field$astNode2 === void 0 ? void 0 : _field$astNode2.type);
      }
      if (isRequiredInputField(field2) && field2.deprecationReason != null) {
        var _field$astNode3;
        context.reportError(`Required input field ${inputObj.name}.${field2.name} cannot be deprecated.`, [
      ...
      for (const field2 of Object.values(fieldDefs)) {
        ...
        if (fieldValue === void 0) {
          if (field2.defaultValue !== void 0) {
            ...
            onError(pathToArray(path), inputValue, new GraphQLError(`Field "${field2.name}" of required type "${typeStr}" was not provided.`));
          }
          continue;
        }
        coercedValue[field2.name] = coerceInputValueImpl(fieldValue, field2.type, onError, addPath(path, field2.name, type.name));
      }
    ...
    if (isLeafType(type)) {
      ...
      try {
        ...
        if (error2 instanceof GraphQLError) {
          ...
          onError(pathToArray(path), inputValue, new GraphQLError(`Expected type "${type.name}". ` + error2.message, void 0, void 0, void 0, void 0, error2));
        }
        return;
      }
  ...
  function execute(args) {
    ...
    try {
      ...
      if (isPromise(result)) {
        return result.then((data2) => buildResponse(data2, exeContext.errors), (error2) => {
  ...
  function extendSchemaImpl(schemaConfig, documentAST, options) {
    ...
    function extendInputObjectType(type) {
      ...
      return new GraphQLInputObjectType(__spreadProps(__spreadValues({}, config), {
        fields: () => __spreadValues(__spreadValues({}, mapValue(config.fields, (field2) => __spreadProps(__spreadValues({}, field2), {
    ...
    function extendEnumType(type) {
      ...
      return new GraphQLEnumType(__spreadProps(__spreadValues({}, config), {
        values: __spreadValues(__spreadValues({}, config.values), buildEnumValueMap(extensions2)),
        extensionASTNodes: config.extensionASTNodes.concat(extensions2)
      }));
    }
    ...
    function extendObjectType(type) {
      ...
      return new GraphQLObjectType(__spreadProps(__spreadValues({}, config), {
        ...
        fields: () => __spreadValues(__spreadValues({}, mapValue(config.fields, extendField)), buildFieldMap(extensions2)),
        extensionASTNodes: config.extensionASTNodes.concat(extensions2)
      }));
    }
  ...
  function lexicographicSortSchema(schema) {
    ...
    function sortFields2(fieldsMap) {
      return sortObjMap(fieldsMap, (field2) => __spreadProps(__spreadValues({}, field2), {
        type: replaceType(field2.type),
